...
include_once("../controlador/menu_con_descripcion.php");
...
<head>
    ...
    <title>Modificar Descripción Menú</title>
    <!-- Normalize V8.0.1 -->
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <em class="fas fa-clipboard-list fa-fw"></em> &nbsp; MODIFICAR DESCRIPCIÓN DEL MENÚ
                </h3>
            </div>
            <div class="container shadow p-3 mb-5 bg-body rounded">
            <form action="" name="modificar_menu_descripcion" method="POST" enctype="multipart/form-data">
                <table>
                <thead><th></th></thead>
                    <tbody>
                        <tr>                            
            ...
            <div class="col" style="text-align:right;"> 
                ...
                <button type="submit" name="modifica3" class="btn btn-primary"  onclick="return validar_modificar_menu_descripcion (this.form)" ><em class="fa fa-pencil-square-o" aria-hidden="true"> Modificar</em></button>      
            </div>
            </form>
            <br>
            </div>
