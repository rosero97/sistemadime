...
include("../controlador/codigo_con.php");
        ...
        <!-- el js del exit class="btn-exit-system" -->
          <i class="fas fa-power-off"></i>
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="bi bi-key-fill"></i> &nbsp; GENERAR CODIGO DE ADMINISTRADOR
                </h3>
            </div>
            <div class="container shadow p-3 mb-5 bg-body rounded">
            <form action="" name="agregar_admin" method="POST" >
              <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-default">Correo Electronico</span>
                <input type="text" name="correo_admin" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required>
              </div>
              <div class="input-group mb-3">
                <button class="btn btn-outline-secondary" type="button" id="button-addon1" onclick="generar()">Generar codigo</button>
                <input type="text" name="codigo_admin" class="form-control" aria-label="Example text with button addon" aria-describedby="button-addon1" id="codigo" value="" readonly>
              </div>
              <div style="text-align:right;">
                  <button type="reset" class="btn btn-danger"><i class="fa fa-ban" aria-hidden="true"> Cancelar</i></button>
                  <button type="submit" name="enviar_correo" class="btn btn-primary"><i class="fa fa-floppy-o" aria-hidden="true"> Enviar Correo</i></button>
              </div>
            </form>
            <br>
            </div>
