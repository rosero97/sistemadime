    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fa fa-table" aria-hidden="true"></i> &nbsp; MESAS
                </h3>              
            </div>
                <div class="container shadow p-3 mb-5 bg-body rounded">
                    <div class="table-responsive">
                    <div class="mesas">
                        <img src="../../imagenes/mesas.jpg" alt="50%">
                    </div><br>
                    <div style="text-align: center;">
                        <a href="reservacion.php"><button class="btn btn-danger"><i class="fa fa-arrow-circle-left" aria-hidden="true"> Volver</i></button></a>
                    </div>
                </div>
            </div>
        </section>
