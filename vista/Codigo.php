...
*/
            ...
            $mail->Body ='Hola! <br><br> Recibimos tu solicitud para recuperar tu contraseña, para continuar con este proceso da clik en el siguiente boton: <br><br><a href="localhost/variado/sistema/sistemadime/vista/Cambio%20de%20contrase%C3%B1a.php"><input type="button" style=" color: blue; background: white; border-radius: 5px; border: solid blue 1px; " value="Clik aqui"></a> <br><br> Atentamente los desarrolladores de Digital menú';
//            $mail->msgHTML($body);
            $mail->send();
