...
include_once("../controlador/admin_contra_con.php");
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                <em class="fa fa-cog" aria-hidden="true"></em> &nbsp; MODIFICAR CONTRASEÑA
                </h3>              
            </div>
			<div class="container shadow p-3 mb-5 bg-body rounded">
                <form action="" method="POST">
                    ...
                    <div class="col" style="text-align:right;"> 
                        ...
                        <button type="submit" class="btn btn-primary" id="modifica2" name="modifica2" onclick="return validar_contra_admin(this.form)"><em class="fa fa-floppy-o" aria-hidden="true"> Guardar</em></button>        
                    </div>
                </form>
            </div>		
		</section>
