			...
			<div class="container shadow p-3 mb-5 bg-body rounded">
                <form action="" method="POST">
                    ...
                    <div class="col" style="text-align:right;"> 
                        ...
                        <button type="submit" class="btn btn-primary" id="modifica2" name="modifica2" onclick="return validar_contra_admin(this.form)"><i class="fa fa-floppy-o" aria-hidden="true"> Guardar</i></button>        
                    </div>
                </form>
            </div>		
		</section>
