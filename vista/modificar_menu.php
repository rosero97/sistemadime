    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="col" style="text-align:right;"> 
                ...
                <button type="submit" name="modifica" class="btn btn-primary"  onclick="return validar_modificar_menu (this.form)" ><em class="fa fa-pencil-square-o" aria-hidden="true"> Modificar</em></button>      
            </div>
            </form>
            <br>
            </div>
