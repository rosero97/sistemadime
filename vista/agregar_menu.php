    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <em class="fas fa-clipboard-list fa-fw"></em> &nbsp; AGREGAR MENÚ
                </h3>
            </div>
            ...
            <div class="col" style="text-align:right;"> 
                ...
                <button type="submit" name="guarda" class="btn btn-primary" onclick="return validar_agregar_menu(this.form)"><em class="fa fa-floppy-o" aria-hidden="true"> Guardar</em></button>
            </div>
            </form>
            <br>
            </div>
