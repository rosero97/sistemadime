    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-clipboard-list fa-fw"></i> &nbsp; ELIMINAR PLATO
                </h3>
            </div>
                ...
                <table>
                    ...
                    <tr>
                            ...
                            <div>
                                ...
                                <input type="text" id="nombre" value="<?php echo $obj->nombre?>" name="nombre" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" readonly>    
                            </div>
                            <br>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" id="descripcion" value="<?php echo $obj->descripcion?>" name="descripcion" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" readonly>    
                            </div>
                            <br>
                            <div>
                                <span class="input-group-text" id="inputGroup-sizing-default">Id del administrador</span>
                                <input type="text" id="ida" value="<?php echo $obj->ida?>" name="ida" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="En este espacio se incuira su id" readonly>    
                            </div>
                        </tr>
                    </tbody>          
                </table>
