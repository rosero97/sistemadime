...
include_once("../controlador/admin_nombre_con.php");
...
<head>
	...
	<title>Configuración Nombre Administrador</title>
			...
			<div class="container shadow p-3 mb-5 bg-body rounded">
                ...
                <form action="" method="POST">
					...
					<thead><th></th></thead>
                        <tbody>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,75}" id="nombre" name="nombre" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                            </div>
                            <br>
                        </tbody>
                    </table>
                    <div class="col" style="text-align:right;"> 
                        ...
                        <button class="btn btn-primary" id="modifica" name="modifica" onclick="return validar_nombre_admin(this.form)"><em class="fa fa-floppy-o" aria-hidden="true"> Guardar</em></button>        
                    </div>                    
                </form>
            </div>		
		</section>
