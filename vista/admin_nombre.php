...
include("../controlador/admin_nombre_con.php");
			...
			<div class="container shadow p-3 mb-5 bg-body rounded">
                ...
                <form action="" method="POST">
                    ...
                    <div class="col" style="text-align:right;"> 
                        ...
                        <button class="btn btn-primary" id="modifica" name="modifica" onclick="return validar_nombre_admin(this.form)"><i class="fa fa-floppy-o" aria-hidden="true"> Guardar</i></button>        
                    </div>                    
                </form>
            </div>		
		</section>
